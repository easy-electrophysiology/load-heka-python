    ...
    def __init__(self, n=1):
        ...
        self.description = [
            ...
            (
                ...
                "5s",
                cstr,
            ),  # (* ARRAY[0..5] OF CHAR *)  (This seems to be a typo on the spec file and should be (* ARRAY[0..4] OF CHAR *)
...
class StimRootRecord(Description):
    def __init__(self, n=1):
        ...
        self.description = [
            ("roVersion", "i"),  # (* INT32 *)
            ("roMark", "i"),  # (* INT32 *)
            ("roVersionName", "32s"),  # (* String32Type *)
            ("roMaxSamples", "i"),  # (* INT32 *)
            ("roFiller1", "i"),  # (* INT32 *)
            # (* StimParams     = 10  *)
            # (* StimParamChars = 320 *)
            ("roParams", "10d"),  # (* ARRAY[0..9] OF LONGREAL *)
            ("roParamText", "320s"),  # (* ARRAY[0..9],[0..31]OF CHAR *)
            ("roReserved", "128s"),  # (* String128Type *)
            ("roFiller2", "i"),  # (* INT32 *)
            ("roReserved2", "560b"),  # (* 560 Bytes *)
            ("roCRC", "I"),  # (* CARD32 *)
        ]
        self.size = 1144
...
class SweepRecord(Description):
    def __init__(self, n=1):
        ...
        self.description = [
            ...
            ("SwTime", "d"),  # (* LONGREAL *)
            ("SwTimer", "d"),  # (* LONGREAL *)
            ("SwSwUserParams", "2d"),  # (* ARRAY[0..1] OF LONGREAL *)
            ("SwPipPressure", "d"),  # (* LONGREAL *)
            ("SwRMSNoise", "d"),  # (* LONGREAL *)
            ...
            ("SwSwUserParamEx", "8d"),  # (* ARRAY[0..7] OF LONGREAL *)
        ]
        self.size = 352
    ...
    def __init__(self, n=1):
        ...
        self.description = [
            ...
            (
                "SeAmplStateFlag",
                "i",
            ),  # (* INT32 *) // flag > 0 => load local oldAmpState, otherwise load from .amp File.
            ("SeAmplStateRef", "i"),  # (* INT32 *) // ref  = 0 => use local oldAmpState
            ("SeMethodTag", "i"),  # (* INT32 *)
            ("SeTime", "d"),  # (* LONGREAL *)
            ("SePageWidth", "d"),  # (* LONGREAL *)
            ("SeUserDescr1", "80s", UserParamDescrType(2)),  # (* ARRAY[0..1] OF UserParamDescrType = 2*40 *)
            ("SeFiller1", "80s", UserParamDescrType(2)),  # (* ARRAY[0..1] OF UserParamDescrType = 2*40 *)
            ("SeMethodName", "32s", cstr),  # (* String32Type *)
            ("SePhotoParams1", "4d"),  # (* ARRAY[0..3] OF LONGREAL = 4*8 *)
            ("SeOldLockInParams", "96s", LockInParams_v9()),  # (* SeOldLockInSize = 96, see "Pulsed.de" *)
            (
                "SeOldAmpState",
                "400s",
                AmplifierState_v9(),
            ),  # (* SeOldAmpState = 400 -> the AmplStateRecord is now stored in the .amp file *)
            ("SeUsername", "80s", cstr),  # (* String80Type *)
            ("SePhotoParams2", "160s", UserParamDescrType(4)),  # (* ARRAY[0..3] OF UserParamDescrType = 4*40 *)
            ("SeFiller1", "i"),  # (* INT32 *)
            ("SeCRC", "I"),  # (* CARD32 *)
            ...
            ("SeScanParams", "96s"),  # (* ScanParamsSize = 96 (ElProScan Extension) *)
            ("SeUserDescr2", "320s", UserParamDescrType(8)),  # (* ARRAY[0..7] OF UserParamDescrType = 8*40 *)
        ]
        self.size = 1728
...
class AmplStateRecord(Description):
    def __init__(self, n=1):
        ...
        self.description = [
            ...
            ("AmIntSol", "i"),  # (* INT32 *)
            ("AmExtSol", "i"),  # (* INT32 *)
            ("AmFiller5", "36s", cstr),  # (* spares: 36 bytes *)
            ("AmCRC", "I"),  # (* CARD32 *)
        ]
        self.size = 560
...
class MethodRecord(Description):
    def __init__(self, n=1):
        ...
        self.description = [
            ...
            ("oa1", "?"),  # (* BOOLEAN *)
            ("oa2", "?"),  # (* BOOLEAN *)
            ("oaGraph0", "1824s", GraphRecord(12)),  # (* MaxFileGraphs * GraphRecSize = 1824 *)
            ("oa3", "i"),  # (* INT32 *)
            ("oaCRC", "I"),  # (* CARD32 *)
            ("oaHeaders", "384s", cstr),  # (* MaxFileGraphs * String32Size =  384 *)
            ("oaLastXmin", "12d"),  # (* MaxFileGraphs * LONGREAL     =   96 *)
            ("oaLastXmax", "12d"),  # (* MaxFileGraphs * LONGREAL     =   96 *)
            ("oaLastYmin", "12d"),  # (* MaxFileGraphs * LONGREAL     =   96 *)
            ("oaLastYmax", "12d"),  # (* MaxFileGraphs * LONGREAL     =   96 *)
        ]
        self.size = 2640
