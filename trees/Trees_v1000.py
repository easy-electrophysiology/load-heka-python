...
class PulSeriesRecord(Description):
    def __init__(self, n=1):
        ...
        self.description = [
            ...
            ("SeAmplStateFlag",         "i"),                                               # (* INT32 *) // flag > 0 => load local oldAmpState, otherwise load from .amp File.
            ...
            ("SeOldAmpState",           "400s",             AmplifierState_v9()),           # (* SeOldAmpState = 400 -> the AmplStateRecord is now stored in the .amp file *)
